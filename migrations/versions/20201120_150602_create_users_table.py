...
def upgrade():
    ...
    op.create_table('cards',
                    ...
                    sa.Column('is_question', sa.Integer(),
    ...
    sa.ForeignKeyConstraint(['user'], ['users.id'], ),
    sa.PrimaryKeyConstraint('user', 'game')
    )
    if environment == "production":
        op.execute(f"ALTER TABLE user_games SET SCHEMA {SCHEMA};")
    ...
    sa.ForeignKeyConstraint(['room_id'], ['games.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    if environment == "production":
...
def downgrade():
    ...
    #NEED TO ADD DROP TABLES FOR DEPLOY
